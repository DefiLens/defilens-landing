...
const Header = () => (
    <div className="fixed right-0 left-0 z-10 flex justify-between items-center gap-3 bg-primary-100 md:border md:shadow-lg md:rounded-full m-0 md:mx-24 my-1 md:my-5 p-3 ">
        <Link
            href="/"
            className=""
        >
