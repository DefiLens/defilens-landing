...
const HowToUse = ({
    ...
    <div className="z-0 min-h-screen auto flex flex-col justify-start items-center gap-3 text-primary-1000 bg-primary-100 p-8 py-20 sm:p-20 sm:py-20 md:p-32 md:py-20 lg:p-38 lg:py-20 2xl:p-40 2xl:py-28">
        ...
        <div className="w-full lg:hidden flex flex-col justify-start items-center gap-5 p-10 mt-8">
        ...
        <motion.div
            className="w-full hidden lg:flex flex-col justify-start items-center gap-5 border-2 shadow-lg rounded-xl p-10 mt-8"
        >
            <div className="w-full flex flex-col lg:flex-row justify-start items-center gap-5">
                ...
                <div className="flex flex-row lg:flex-col justify-center items-center gap-5 p-3">
                    <div className="w-20 lg:w-0 lg:h-20 bg-gradient-to-l lg:bg-gradient-to-t from-primary-1000 to-transparent p-[1px] rounded-full" />
                    <div className="h-7 w-7 flex justify-center items-center text-sm text-primary-100 bg-primary-500 ring-8 ring-primary-450 rounded-full">
                        {HowToUseList[active - 1]?.id}
                    </div>
                    <div className="w-20 lg:w-0 lg:h-20 bg-gradient-to-r lg:bg-gradient-to-b from-primary-1000 to-transparent p-[1px] rounded-full" />
                </div>
                <motion.div
                    className="flex flex-col justify-center items-strat gap-3 p-5 lg:px-5"
                >
                    <h1 className="text-center lg:text-start text-lg md:text-xl lg:text-2xl font-bold !leading-tight">
