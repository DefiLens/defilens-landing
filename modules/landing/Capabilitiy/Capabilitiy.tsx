    ...
    <div className="social-graph px-[150px] py-[50px]">
        <div className="flex flex-col justify-center items-center text-[22px]">
            ...
            <div className="mt-[40px] text-center w-[80%]">
                DefiLens is crafting a revolutionary platform that redefines how
                users engage with the Defi ecosystem. At its core, the platform
                introduces a streamlined trading experience through two key
                pillars: Cross-chain Lending and Smart Batching
            </div>
        </div>
